...
namespace Framework::Matrix
{
	...
	/* In row-major form. Right-handed. Counter-clockwise rotation. */ void ToEuler( const Matrix4x4& matrix, Radians& heading_around_y, Radians& pitch_around_x, Radians& bank_around_z );
